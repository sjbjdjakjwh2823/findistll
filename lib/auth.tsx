...
const SUPABASE_ANON_KEY = process.env.NEXT_PUBLIC_SB_KEY
    ...
    || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5udWl4cXhtYWx0dGF1dGNxY2t0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjgzNjQ1NjIsImV4cCI6MjA4Mzk0MDU2Mn0.RKQm2hVC7IkuW_ldtGedJQtWr15RrAJYWWMkJ5SWdAM';  // Fallback for debugging
